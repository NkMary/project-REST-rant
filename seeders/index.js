...
const createPlace = () => {
    const cityStateKey = Object.keys(places)[Math.floor(Math.random()*Object.values(places).length)]
...
const main = async () => {
    ...
    for (let i=0; i < 1600; i++) {
        const place = createdPlaces[Math.floor(Math.random()*createdPlaces.length)]
